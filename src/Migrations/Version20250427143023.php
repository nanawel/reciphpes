 ...
 */
final class Version20250427143023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient AS SELECT id, created_at, name FROM ingredient');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('CREATE TABLE ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE NOCASE, sort_name VARCHAR(255) DEFAULT NULL COLLATE NOCASE)');
        $this->addSql('INSERT INTO ingredient (id, created_at, name) SELECT id, created_at, name FROM __temp__ingredient');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6BAF787088C2E7C ON ingredient (sort_name)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, location_id, created_at, name, location_details, instructions FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, location_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE NOCASE, location_details VARCHAR(255) DEFAULT NULL COLLATE NOCASE, instructions CLOB DEFAULT NULL COLLATE NOCASE, CONSTRAINT FK_DA88B13764D218E FOREIGN KEY (location_id) REFERENCES location (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recipe (id, location_id, created_at, name, location_details, instructions) SELECT id, location_id, created_at, name, location_details, instructions FROM __temp__recipe');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipeingredient AS SELECT recipe_id, ingredient_id, note FROM recipeingredient');
        $this->addSql('DROP TABLE recipeingredient');
        $this->addSql('CREATE TABLE recipeingredient (recipe_id INTEGER NOT NULL, ingredient_id INTEGER NOT NULL, note VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(recipe_id, ingredient_id), CONSTRAINT FK_31F2F78B59D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_31F2F78B933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recipeingredient (recipe_id, ingredient_id, note) SELECT recipe_id, ingredient_id, note FROM __temp__recipeingredient');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('CREATE TABLE ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE NOCASE, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO ingredient (id, name, created_at) SELECT id, name, created_at FROM __temp__ingredient');
        $this->addSql('DROP TABLE __temp__ingredient');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6BAF78705E237E06 ON ingredient (name)');
        $this->addSql('CREATE INDEX INGREDIENT_NAME_IDX ON ingredient (name)');
        $this->addSql('DROP INDEX IDX_DA88B13764D218E');
        $this->addSql('DROP INDEX RECIPE_NAME_IDX');
        $this->addSql('DROP INDEX RECIPE_INSTRUCTIONS_IDX');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, location_id, name, location_details, instructions, created_at FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, location_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE NOCASE, location_details VARCHAR(255) DEFAULT NULL COLLATE NOCASE, instructions CLOB DEFAULT NULL COLLATE NOCASE, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO recipe (id, location_id, name, location_details, instructions, created_at) SELECT id, location_id, name, location_details, instructions, created_at FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
        $this->addSql('CREATE INDEX IDX_DA88B13764D218E ON recipe (location_id)');
        $this->addSql('CREATE INDEX RECIPE_NAME_IDX ON recipe (name)');
        $this->addSql('CREATE INDEX RECIPE_INSTRUCTIONS_IDX ON recipe (instructions)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_timeofyear AS SELECT recipe_id, timeofyear_id FROM recipe_timeofyear');
        $this->addSql('DROP TABLE recipe_timeofyear');
        $this->addSql('CREATE TABLE recipe_timeofyear (recipe_id INTEGER NOT NULL, timeofyear_id INTEGER NOT NULL, PRIMARY KEY(recipe_id, timeofyear_id))');
        $this->addSql('INSERT INTO recipe_timeofyear (recipe_id, timeofyear_id) SELECT recipe_id, timeofyear_id FROM __temp__recipe_timeofyear');
        $this->addSql('DROP TABLE __temp__recipe_timeofyear');
        $this->addSql('CREATE INDEX IDX_42E0B96959D8A214 ON recipe_timeofyear (recipe_id)');
        $this->addSql('CREATE INDEX IDX_42E0B96924BFD492 ON recipe_timeofyear (timeofyear_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipeingredient AS SELECT recipe_id, ingredient_id, note FROM recipeingredient');
        $this->addSql('DROP TABLE recipeingredient');
        $this->addSql('CREATE TABLE recipeingredient (recipe_id INTEGER NOT NULL, ingredient_id INTEGER NOT NULL, note VARCHAR(255) DEFAULT NULL, PRIMARY KEY(recipe_id, ingredient_id))');
        $this->addSql('INSERT INTO recipeingredient (recipe_id, ingredient_id, note) SELECT recipe_id, ingredient_id, note FROM __temp__recipeingredient');
        $this->addSql('DROP TABLE __temp__recipeingredient');
        $this->addSql('CREATE INDEX IDX_31F2F78B59D8A214 ON recipeingredient (recipe_id)');
        $this->addSql('CREATE INDEX IDX_31F2F78B933FE08C ON recipeingredient (ingredient_id)');
