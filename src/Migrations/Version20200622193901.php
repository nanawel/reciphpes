 ...
 */
final class Version20200622193901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql(
            'INSERT INTO ingredient (id, created_at, name) SELECT id, created_at, name FROM __temp__ingredient'
        );
        ...
        $this->addSql(
            'CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, location_id, location_details, instructions, created_at, name FROM recipe'
        );
        $this->addSql('DROP TABLE recipe');
        $this->addSql(
            'CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, location_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, location_details VARCHAR(255) DEFAULT NULL COLLATE NOCASE, instructions CLOB DEFAULT NULL COLLATE NOCASE, name VARCHAR(255) NOT NULL COLLATE NOCASE, CONSTRAINT FK_DA88B13764D218E FOREIGN KEY (location_id) REFERENCES location (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)'
        );
        $this->addSql(
            'INSERT INTO recipe (id, location_id, location_details, instructions, created_at, name) SELECT id, location_id, location_details, instructions, created_at, name FROM __temp__recipe'
        );
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, created_at, name FROM location');
        ...
        $this->addSql('INSERT INTO location (id, created_at, name) SELECT id, created_at, name FROM __temp__location');
